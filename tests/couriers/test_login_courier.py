...
class TestLoginCourier:
    ...
    def test_login_courier_no_login(self, create_courier):
        payload = {
            "password": create_courier[1],
        }
        response = requests.post(f"{BASE_URL}{COURIERS_URL}{LOGIN_COURIER}", json=payload)
    ...
    def test_login_courier_no_password(self, create_courier):
        payload = {
            "login": create_courier[0],
        }
        response = requests.post(f"{BASE_URL}{COURIERS_URL}{LOGIN_COURIER}", json=payload)
    ...
    def test_login_courier_no_body(self, create_courier):
        payload = {}
        response = requests.post(f"{BASE_URL}{COURIERS_URL}{LOGIN_COURIER}", json=payload)
    ...
    def test_login_courier_random_password(self, create_courier):
        payload = {
            "login": create_courier[0],
    ...
    def test_login_courier_random_login(self, create_courier):
        payload = {
            "password": create_courier[1],
